!function() {
    ...
    function zt(n) {
        ...
        return function(n) {
            ...
            switch (h && (h =+ h.substring(1)), (s || "0" === r && "=" === o) && (s = r = "0", o = "=", f && (l -= Math.floor((l-1) / 4))),
            g) {
            case"n":
                f=!0, g = "g";
                break;
        ...
        function e(n, t, e, r) {
            for (var u, i, o, a = 0, c = t.length, s = e.length; c > a;) {
                ...
                if (u = t.charCodeAt(a++), 37 === u) {
                    if (o = t.charAt(a++), i = N[o in uc ? t.charAt(a++) 
        ...
        for (var a = 0, c = t.length; c > a; ++a) {
            ...
            if (l)
                for (var f = s[0], h = f[0], g = f[1] / 2 + Sa / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ;) {
                    ...
                    if (hc.add(Math.atan2(w * Math.sin(_), v * M + w * Math.cos(_))), i += b ? _ + (_ >= 0 ? ka : - ka) 
                        : _, b^h >= e^m >= e) {
                            var S = fe(se(f), se(n));
                            pe(S);
                            var k = fe(u, S);
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p)
                        , (de(e, g) || de(p, g)) && (p[0] += Aa, p[1] += Aa, v = t(p[0], p[1]))), v !== c)l = 0, v ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
                    else if (a && e && o^v) {
                        var m;
    ...
    function nu(n, t) {
        ...
        )if (u = Bc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== e || i.y !== r) && (Xc[i.i] = new Pr(i), Tr(i), e = i.x, r = i.y)
            , i = n.pop();
        else {
            if (!u)
                break;
    ...
    function lu(n, t) {
        ...
        for (n += "", t += "", Qc.lastIndex = 0, r = 0; e = Qc.exec(t);
        ++r)e.index && s.push(t.substring(a, c = e.index)), l.push({
            i: s.length,
            x: e[0]
        }), s.push(null), a = Qc.lastIndex;
        for (a < t.length && s.push(t.substring(a)), r = 0, i = l.length; (e = Qc.exec(n)
            ) && i > r;
        ++r)if (o = l[r], o.x == e[0]) {
            if (o.i)
                if (null == s[o.i + 1])
    ...
    function Ru(n, t) {
        ...
        return a[0] != c[0] || a[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), u.push({
            ...
            i : r.push(r.pop() + "rotate(", null, ")")-2, x : su(s, l)
    ...
    function bi(n) {
        ...
        if ((e = n.children) && (s = e.length)) {
            ...
            if (e.forEach(wi), r = e[0], r.x =- r.r, r.y = 0, t(r)
                , s > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), s > 2))for (i = e[2], Ei(r, u, i)
                , t(i), xi(r, i), r._pack_prev = i, xi(i, u), u = r._pack_next, o = 3;
            s > o;
            o++) {
                Ei(r, u, i = e[o]);
                var p = 0, v = 1, d = 1;
    ...
    function Gi(n, t) {
        function e() {
            ...
            for (u = [];
            ++e < i;
            )u[e-1] = Xo.quantile(n, e / i); return r
        }
        function r(n) {
    ...
    function io(n) {
        function t(t) {
            ...
            for (var c, s = [], l = [], f =- 1, h = t.length, g = _t(e)
                , p = _t(r);
            ++f < h;
    ...
    function So(n) {
        for (var t = 0, e = n.length-1, r = [], u = n[0], i = n[1], o = r[0] = wo(u, i);
        ++t < e;
    ...
    function Co(n) {
        function t(t) {
            ...
            for (var h, g, p, v = [], d = [], m = [], y =- 1, x = t.length, M = _t(e)
                , _ = _t(u), b = e === r ? function() {
                return g
            } : _t(r), w = u === i ? function() {
                return p
            } : _t(i);
    ...
    Xo.bisectLeft = ia.left, Xo.bisect = Xo.bisectRight = ia.right, Xo.shuffle = function(n) {
        ...
        if (!(u = arguments.length))
            return [];
        for (var n =- 1, e = Xo.min(arguments, t)
            , r = new Array(e);
        ++n < e;
    ...
    Zc.area = function() {
        ...
        for (var t, e, r, u, i, o, a = Cr(n), c =- 1, s = this.length - Cr(this)
            , l = this[s-1];
        ++c < s;
        ) {
    ...
    Pr.prototype.prepare = function() {
        ...
        remove: function(n) {
            ...
            if (e = i ? o ? Qr(o) : i : o, u ? u.L === n ? u.L = e : u.R = e : this._ = e, i && o ? (r = e.C, e.C = n.C, e.L = i, i.U = e, e !== o ? (u = e.U, e.U = n.U, n = e.R, u.L = n, e.R = o, o.U = e) 
                : (e.U = u, u = e, n = e.R)) : (r = n.C, n = e), n && (n.U = u), !r) {
                if (n && n.C)
                    return n.C=!1, void 0;
                do {
                    if (n === this._)
    ...
    Xo.layout.hierarchy = function() {
        function n(t, o, a) {
            ...
            if (t.depth = o, a.push(t)
                , c && (s = c.length)) {
                for (var s, l, f =- 1, h = t.children = new Array(s)
                    , g = 0, p = o + 1;
                ++f < s;
    ...
    Xo.layout.histogram = function() {
        ...
        function n(n, i) {
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], s = i._tree.mod, l = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = si(a), i = ci(i)
                        , a && i;
    ...
    Xo.svg.brush = function() {
        ...
        function u() {
            ...
            if (Xo.event.changedTouches ? z.on("touchmove.brush", v).on("touchend.brush", y) : z.on("mousemove.brush", v).on("mouseup.brush", y), S.interrupt().selectAll("*").interrupt()
                , C)L[0] = l[0] - L[0], L[1] = f[0] - L[1];
            else if (k) {
